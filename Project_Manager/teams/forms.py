...
class AddTeamForm(forms.ModelForm):
    ...
    name = forms.CharField(
        widget=forms.TextInput(attrs={
            'class': 'input input-bordered w-full bg-white text-gray-800 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent',
    ...
    description = forms.CharField(
        widget=forms.Textarea(attrs={
            'class': 'textarea textarea-bordered w-full bg-white text-gray-800 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent h-24',
